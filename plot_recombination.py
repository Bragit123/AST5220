...
plt.plot(a, recomb_df["g_tilde"], label="$\\tilde{g}$")
plt.plot(a, recomb_df["dgdx_tilde"], label="$\\frac{d\\tilde{g}}{dx}$")
plt.plot(a, recomb_df["ddgddx_tilde"], label="$\\frac{d^2\\tilde{g}}{dx^2}$")
plt.xscale("log")
plt.xlabel("Scalefactor $a$")
